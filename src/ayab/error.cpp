...
/*!
 * \brief Initialize OpState::Error
 */
void Error::init() {
}

/*!
 * \brief Start OpState::Error
...
/*!
 * \brief Update method for OpState::Error
 */
void Error::update() {
  // every 500ms
...
/*!
 * \brief Communication callback for OpState::Error
 */
void Error::com() {
}

/*!
 * \brief Finish OpState::Error
 */
void Error::end() {
