...
public:
  ...
  virtual void knit() = 0;
  virtual void indState(Err_t error = static_cast<uint8_t>(ErrorCode::SUCCESS)) = 0;
...
public:
  ...
  static bool isReady();
  static void knit();
  static void indState(Err_t error = static_cast<uint8_t>(ErrorCode::SUCCESS));
...
public:
  ...
  bool isReady() final;
  void knit() final;
  void indState(Err_t error = static_cast<uint8_t>(ErrorCode::SUCCESS)) final;
